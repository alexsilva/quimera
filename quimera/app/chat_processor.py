...
class ChatProcessor:
    ...
    def __init__(
        ...
        *,
        ...
        self.app = app
        self._chat_worker_cls = chat_worker_cls
        self._turn_manager_cls = turn_manager_cls
    ...
    def run(self) -> None:
        ...
        if not hasattr(app, "turn_manager") or app.turn_manager is None:
            app.turn_manager = self._turn_manager_cls()
        ...
        if threaded_chat:
            ...
            chat_executor = self._executor_cls(
            ...
            chat_worker = self._chat_worker_cls(
