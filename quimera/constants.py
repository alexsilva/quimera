...
PROMPT_BASE_RULES = (
    ...
    "- Se houver confusão sobre o estado da conversa, resuma o que você entendeu e indique seu próximo passo.\n"
    "- Sempre que sua resposta depender de ação de outro agente, explicite o que espera que aconteça.\n"
    ...
    "- Colaboração explícita: colaborar é parte do trabalho, não apenas resolver a tarefa isoladamente.\n"
    "- Auto-correção de comunicação: se a resposta estiver desconexa, revise o estado atual e proponha uma síntese clara antes de prosseguir.\n"
    "- Evitar duplicação de esforço: reconheça trabalhos já realizados por outros agentes e construa a partir deles.\n"
    "- Indicar o próximo passo ao finalizar handoff/tarefa para guiar o sintetizador.\n"
    "- Siga rigorosamente o formato de saída esperado (ROUTE, STATE_UPDATE, etc.) para que o sistema consiga parsear sua resposta.\n"
    "\n"
    "PROATIVIDADE:\n"
    "- Seja proativo quando apropriado: identifique problemas adjacentes à tarefa e avise, mas NÃO resolva sem pedido.\n"
...
HANDOFF_SYNTHESIS_MSG = (
    ...
    "Não repita a resposta do {agent} — incorpore-a na sua conclusão.\n"
    ...
    "Evite redundância: se a resposta do {agent} já cobriu um ponto, não o repita — avance para o próximo não resolvido.\n"
...
PROMPT_REVIEWER_RULE = (
    ...
    "- Não repita o que já foi resolvido; discorde com uma alternativa concreta quando necessário.\n"
    "- Identifique lacunas não abordadas e proponha formas de preenchê-las.\n"
    "- Forneça uma síntese da evolução da conversa ao revisar, para facilitar a continuidade.\n"
    "- Se a resposta anterior estiver confusa ou muito longa, reestruture-a em pontos claros.\n"
...
PROMPT_HANDOFF_RULE = (
    ...
    "- NÃO expanda o escopo além do que foi pedido — foque na tarefa descrita em 'task'.\n"
)
