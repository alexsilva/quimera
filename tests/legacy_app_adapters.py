...
def system_layer_from_app(app, **overrides):
    ...
    kwargs = dict(
        ...
        sandbox_enabled_getter=getattr(app, "get_sandbox_enabled", None),
        sandbox_enabled_setter=getattr(app, "set_sandbox_enabled", None),
        sandbox_available_checker=getattr(app, "is_sandbox_available", None),
