...
- Carregar tambem `quimera_session_context.md` quando existir, para anexar apenas o resumo local da ultima sessao.
...
- O resumo mutavel da ultima sessao fica em `quimera_session_context.md`, fora do versionamento.
...
- No encerramento, um resumo curado da ultima sessao pode substituir o conteudo de `quimera_session_context.md`.
...
- `quimera_session_context.md`: resumo local mutavel da ultima sessao, nao versionado.
